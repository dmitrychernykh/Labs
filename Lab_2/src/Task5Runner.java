...
public class Task5Runner {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Lab_2.Task5");
        System.out.println("Метод, который вычисленяет n-ое по счету число Фибоначчи через рекурсию");

        int paramN, result, checkResult;

        paramN = 6;
        checkResult = 5;
        result = Task5.fibonachiNumber(paramN);
        ...
        System.out.println("Результат: " + Task5.fibonachiNumber(paramN));
    }
}
